...
System.register("./__entry.js", ['./__monkey.entry-D53wEhWR.js'], (function (exports, module) {
	'use strict';
	return {
		setters: [null],
		execute: (function () {
...
System.register("./__monkey.entry-D53wEhWR.js", [], (function (exports, module) {
  'use strict';
  return {
    execute: (function () {
      ...
      var _unsafeWindow = exports("_", /* @__PURE__ */ (() => typeof unsafeWindow != "undefined" ? unsafeWindow : void 0)());
...
`;
      ...
      (function() {
        ...
        _GM_registerMenuCommand("JSON示例 ( Alt + J )", openInTab);
        ...
        if (!Utils.isJSON(rawText)) return __vitePreload(() => module.import('./index-oBU1o6se-nCngTgYo.js'), void 0 );
        ...
        setTimeout(async () => {
          ...
          await __vitePreload(() => module.import('./index-CIny2Zmg-Bc50vzGI.js'), void 0 );
          __vitePreload(() => module.import('./index-Lp3uvp-B-C24lrmW9.js'), void 0 );
          __vitePreload(() => module.import('./index-7SRjeOqa-CiimRmMH.js'), void 0 );
        });
      })();
...
System.register("./index-oBU1o6se-nCngTgYo.js", ['highlight.js', 'beautifier', './__monkey.entry-D53wEhWR.js'], (function (exports, module) {
  'use strict';
...
System.register("./index-CIny2Zmg-Bc50vzGI.js", ['./__monkey.entry-D53wEhWR.js', './tippy.esm-D1eoMe9a-Bn9PjR6Y.js'], (function (exports, module) {
  'use strict';
  var Utils, _unsafeWindow, _GM_getValue, _GM_setValue, _GM_setClipboard, tippy;
  return {
    setters: [module => {
      Utils = module.U;
      _unsafeWindow = module._;
      ...
      const evnet = {
        ...
        eventPath() {
          Utils.addEvent("click mouseenter", ".json-key", ({ type, ctrlKey, target }) => {
            ...
            if (ctrlKey && type === "click") return _GM_setClipboard(path) & layer.msg("复制成功", { time: 1500 });
...
System.register("./index-Lp3uvp-B-C24lrmW9.js", ['./tippy.esm-D1eoMe9a-Bn9PjR6Y.js', './__monkey.entry-D53wEhWR.js'], (function (exports, module) {
	'use strict';
	var tippy, Utils;
	return {
		setters: [module => {
...
System.register("./index-7SRjeOqa-CiimRmMH.js", ['./tippy.esm-D1eoMe9a-Bn9PjR6Y.js', 'jsmind', 'dom-to-image', './__monkey.entry-D53wEhWR.js'], (function (exports, module) {
  'use strict';
  var tippy, require$$0, require$$1, Utils, _unsafeWindow, _GM_getValue, URL$1, _GM_setClipboard, _GM_setValue;
  return {
    setters: [module => {
      tippy = module.t;
    }, module => {
      ...
      const jsonMind = {
        ...
        event() {
          Utils.addEvent("click mouseover", "jmnode", ({ type, ctrlKey, target }) => {
            ...
            if (!chain) return;
            if (type === "click") {
              if (ctrlKey) return _GM_setClipboard(chain), layer.msg("复制成功", { time: 1500 });
...
System.register("./tippy.esm-D1eoMe9a-Bn9PjR6Y.js", [], (function (exports, module) {
  'use strict';
  return {
    execute: (function () {
