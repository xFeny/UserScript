...
// @version      1.1.7
// @author       Feny
// @description  哔咪动漫｜E站弹幕网｜饭团动漫，播放页自动网页全屏，快捷键(F)切换。
// @license      MIT
...
(t=>{if(typeof GM_addStyle=="function"){GM_addStyle(t);return}const n=document.createElement("style");n.textContent=t,document.head.append(n)})(" .webFullScreen{top:0!important;left:0!important;margin:0!important;padding:0!important;border:none!important;width:100vw!important;height:100vh!important;position:fixed!important;z-index:2147483646!important}.MacPlayer{border-radius:0!important}#player_iframe{background:#000!important}#zhuXian a{margin:0!important;font-size:12px!important}.nav-area{margin-bottom:20px}#bkcl,.newhd,.ABP-Text,.tuiguang,.play-full,.login-box,.line_button2{width:0!important;height:0!important;display:none!important} ");
