...
(async function (notyf, Swal) {
  ...
  const MenuCommand = {
    ...
    restoreDefaultSetting: () => _GM_listValues().forEach((key) => _GM_deleteValue(key)) & location.reload(),
