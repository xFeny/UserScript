  ...
  class Site {
    ...
    static _loadRemote() {
      ...
      _GM.xmlHttpRequest({ url, timeout: 3e3 }).then((res) => {
        ...
        Storage.ICONS_SELECTOR.set(Consts.EMPTY, this.selectors, 1 / 3);
