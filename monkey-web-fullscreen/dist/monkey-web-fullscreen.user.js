  ...
  const Automatic = {
    ...
    autoExitFullscreen() {
      ...
      requestAnimationFrame(() => {
        const cancel = Tools.query(".bpx-player-ending-related-item-cancel");
