...
(function (notyf, Swal) {
  ...
  const Keydown = {
    preventDefault(event, { code } = event) {
      const preventKeys = [Keyboard.KeyM, Keyboard.KeyP].includes(code);
