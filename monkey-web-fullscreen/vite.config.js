...
const description = [
  "支持所有H5视频的增强脚本，通用网页全屏｜倍速调节，微博/推特/Instagram/Facebook等平台均适用",
...
const description_tw = [
  "支持所有H5视频的增强脚本，通用網頁全屏｜倍速調節，微博/推特/Instagram/Facebook等平臺均適用",
  "默認適配嗶哩嗶哩（含直播）、騰訊視頻、優酷視頻、愛奇藝、芒果TV、搜狐視頻、AcFun彈幕網自動網頁全屏",
