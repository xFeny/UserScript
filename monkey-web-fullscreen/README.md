...
| Z | 恢复正常倍速           | D          | 弹幕显/隐      |
| M | 静音切换 | L / K | 下上帧 |
| Ctrl <b style='color:#bbb'>+</b> Z | 复位变换 | Shift <b style='color:#bbb'>+</b> R | 水平镜像 |
...
| Alt <b style='color:#bbb'>+</b> ◀️🔼🔽▶️ | 移动 (默禁) | ◀️▶️ | 快退/进 |
| 空格      | 播放/暂停         | 1️⃣ - 9️⃣ | 1️⃣ - 9️⃣ 倍速 |
| 数字 0️⃣   | 快进 30 秒                   |                    |                    |
