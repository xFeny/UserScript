...
例如默认预设值为 1.15,1.25,1.45,1.75 时：

- `Ctrl + 1` 对应设置为 `1.15` 倍速
- `Ctrl + 4` 对应设置为 `1.75` 倍速
...
默认在全屏模式下右上角显示时钟、视频剩余时长和进度百分比。若无需该显示，可在设置中直接禁用。

若默认显示颜色干扰视觉注意力，可进入「参数设置」自定义调整时间文本的颜色，以匹配个人使用习惯。

如希望不管是全屏或非全屏下都显示时间，启用「非全屏显示时间」。
